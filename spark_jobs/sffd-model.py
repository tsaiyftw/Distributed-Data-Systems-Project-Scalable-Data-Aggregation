...
sffd_filtered_df = sffd_df.filter((sffd_df['hospital_timestamp'].isNotNull()) &(sffd_df['unit_type'] == 'MEDIC'))
result_df = sffd_filtered_df \
    .groupBy(date_format('hospital_timestamp', 'yyyy-MM').alias('month_year')) \
